...
class MedTrainDataset(Dataset):
    def __init__(self,
        ...
        for excluded_class in self.exclude_classes:
            assert excluded_class in CLASS_NAMES, 'exclude_class: {}, should be in {}'.format(excluded_class, CLASS_NAMES)
    ...
    def load_dataset_folder(self):
        ...
        for class_name_one in CLASS_NAMES:
            if class_name_one != self.class_name and class_name_one not in self.exclude_classes:
